...
def registracija_post():
    ...
    ponovljeno_geslo_v_cistopisu = bottle.request.forms.getunicode("ponovljeno_geslo")
...
def dodaj_racun_post():
    ...
    return bottle.template("dodaj_racun.html", napaka=None, sporocilo=f"Slika uspešno naložena! Dodanih je bilo {len(dodaj_najdeno.nakupljena_zivila)} nakupljenih zivil.")
